...
namespace VariableInventorySystem
{
    ...
    {
        protected List<IVariableInventoryView> InventoryViews { get; } = new List<IVariableInventoryView>();
        ...
        public virtual void AddInventoryView(IVariableInventoryView variableInventoryView)
        {
            ...
            variableInventoryView.Initialize(CellPrefab, OnCellClick, OnCellOptionClick, OnCellEnter, OnCellExit);
        }
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            effectCell.RectTransform.localPosition = cursorPosition + new Vector2(
                 -(width - 1) * effectCell.CellSize.x * 0.5f,
                (height - 1) * effectCell.CellSize.y * 0.5f);
        }
