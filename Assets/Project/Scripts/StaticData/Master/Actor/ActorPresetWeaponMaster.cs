    ...
    public class ActorPresetWeaponMaster
    {
        ...
        ActorPresetWeaponMaster()
        {
            rows = new[]
            {
                ...
                new Row(actorPresetId: 5, weaponIndex: 2, weaponType: WeaponType.ParticleBulletMaker, weaponSpecId: 2),
                new Row(actorPresetId: 5, weaponIndex: 3, weaponType: WeaponType.ParticleBulletMaker, weaponSpecId: 2),
                new Row(actorPresetId: 5, weaponIndex: 4, weaponType: WeaponType.ParticleBulletMaker, weaponSpecId: 2),
                new Row(actorPresetId: 5, weaponIndex: 5, weaponType: WeaponType.ParticleBulletMaker, weaponSpecId: 2),
