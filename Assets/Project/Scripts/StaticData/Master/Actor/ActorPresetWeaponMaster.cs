    ...
    public class ActorPresetWeaponMaster
    {
        ...
        ActorPresetWeaponMaster()
        {
            rows = new[]
            {
                ...
                new Row(actorPresetId: 5, weaponIndex: 0, weaponType: WeaponType.BulletMaker, weaponSpecId: 1),
                new Row(actorPresetId: 5, weaponIndex: 1, weaponType: WeaponType.BulletMaker, weaponSpecId: 1),
                new Row(actorPresetId: 5, weaponIndex: 2, weaponType: WeaponType.BulletMaker, weaponSpecId: 1),
                new Row(actorPresetId: 5, weaponIndex: 3, weaponType: WeaponType.BulletMaker, weaponSpecId: 1),
                new Row(actorPresetId: 5, weaponIndex: 4, weaponType: WeaponType.BulletMaker, weaponSpecId: 1),
                new Row(actorPresetId: 5, weaponIndex: 5, weaponType: WeaponType.BulletMaker, weaponSpecId: 1),
