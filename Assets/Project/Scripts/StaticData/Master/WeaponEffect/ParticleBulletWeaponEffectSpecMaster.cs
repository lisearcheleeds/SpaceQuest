...
namespace AloneSpace
{
    public class ParticleBulletWeaponEffectSpecMaster
    {
        ...
        ParticleBulletWeaponEffectSpecMaster()
        {
            rows = new[]
            {
                new Row(1, new CacheableGameObjectPath("Prefab/WeaponEffect/Projectile/ParticleBullet/ParticleBullet"), 2, 500.0f, 8.0f, 1000.0f, 1.0f, 0.0f),
                new Row(2, new CacheableGameObjectPath("Prefab/WeaponEffect/Projectile/ParticleBullet/ParticleBullet"), 2, 500.0f, 8.0f, 1000.0f, 1.0f, 0.0f),
            };
        }
    }
}
