    ...
    public class MapPanel : MonoBehaviour
    {
        ...
        void UpdateCamera()
        {
            if (ViewMode == MapPanelViewMode.All)
            {
                ...
                cameraOffset.position = mapPanelCells[questData.ObserveActor.AreaIndex].transform.position;
        ...
        void UpdateView()
        {
            ...
            var (_, currentY, currentZ) = questData.MapData.MapPosition[questData.ObserveActor.AreaIndex];
        ...
        {
            MessageBus.Instance.PlayerCommandSetMoveTarget.Broadcast(questData.ObservePlayer.InstanceId, index);
