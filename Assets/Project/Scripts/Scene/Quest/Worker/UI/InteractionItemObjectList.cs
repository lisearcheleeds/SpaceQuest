...
namespace RoboQuest.Quest
{
    public class InteractionItemObjectList : MonoBehaviour
    {
        ...
        void SubscribeUpdateInteractionObjectList(IInteractionObject[] interactionObjects)
        {
            interactionItems = interactionObjects
        ...
        void Refresh()
        {
            ...
            var takeOrderItems = questData.ObservePlayerActors
                .Select(x => x.InteractOrder.OfType<ItemInteractData>().ToArray())
                .ToArray();
